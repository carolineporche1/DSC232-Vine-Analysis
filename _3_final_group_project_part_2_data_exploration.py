# -*- coding: utf-8 -*-
"""#3 Final Group Project Part 2: Data Exploration.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1qLS9L-2DxKVYe4vZ5wNhfQAtpAgXWI1d

This is the cleaner file I have just started working on. I have another one which is 8.84GB for parquet. I think this one will do and its a lot more clean. Let me know what yout think.
"""
...
spark = SparkSession.builder.appName("AmazonReviewsMerge").getOrCreate()
...
df_random_rows.coalesce(8).write.parquet('random_rows.parquet')
